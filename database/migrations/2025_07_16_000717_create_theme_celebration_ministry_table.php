...
return new class extends Migration
{
    ...
    {
        Schema::create('theme_celebration_ministry', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('id_theme_celebration_occurrence', 'fk_celebration_occurrence')
                ->references('id')
    ...
    {
        Schema::dropIfExists('theme_celebration_ministry');
    }
};
