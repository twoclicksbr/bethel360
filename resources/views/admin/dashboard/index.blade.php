...
@section('title', 'Dashboard | ' . config('app.title'))

@php
    $pageTitle = 'Dashboard'; // para o breadcrumb
    $pageHeading = 'Painel da Liderança'; // para o título da página
    $pageDescription = 'Acompanhe os principais indicadores da igreja em tempo real, com gráficos, relatórios e alertas estratégicos para líderes.'; // para o título da página
@endphp
        ...
        <div class="row g-5 g-xl-8">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" multiple="multiple"
                                                ...
                                                data-dropdown-parent="#kt_menu_680f4ee5dd524" data-allow-clear="true">
                                                <option></option>
            ...
            <div class="col-xl-8 ps-xl-12">
                ...
                <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-body mb-5 mb-xl-8"
                    style="background-position: 100% 50px;background-size: 500px auto;background-image:url('{{ asset('assets/media/misc/city.png') }}')"
                    dir="ltr">
                    <!--begin::Body-->
