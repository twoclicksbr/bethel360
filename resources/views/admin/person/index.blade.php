        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5 d-flex justify-content-between align-items-center">
                ...
                <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                    title="">
                    <a href="{{ route('person.create') }}" class="btn btn-sm btn-light-danger btn-active-danger">
                        <i class="ki-outline ki-plus fs-2"></i>Nova Pessoa</a>
                </div>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-start flex-shrink-0">
                                            ...
                                            <a href="#" class="btn btn-icon btn-light btn-active-color btn-sm me-1"
                                                ...
                                                title="<em>Criado em: </em><br> <b>{{ \Carbon\Carbon::parse($person['created_at'])->format('d/m/Y H:i:s') }}</b> <br><br> 
<em>Alterado em: </em><br> <b>{{ \Carbon\Carbon::parse($person['updated_at'])->format('d/m/Y H:i:s') }}</b>">
