                ...
                <div class="d-flex align-items-center order-2 order-md-1">
                    ...
                    <a href="landing.html">
                        <img alt="Logo" src="{{ asset('assets/media/logos/logo-h-white-red.svg') }}"
                            class="h-25px h-md-30px" />
                    </a>

                    <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1" href="https://keenthemes.com">
                        &copy; 2000-{{ date('Y') }} | Todos os direitos.
                        <a href="https://twoclicks.com.br" target="_blank">
                            <i class="ki-outline ki-click text-danger ms-2"></i>
                            <span class="text-white">Two</span><span class="text-danger">Clicks</span>.
                        </a>
                    </span>
